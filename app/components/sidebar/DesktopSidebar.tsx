...
const DesktopSidebar: React.FC<DesktopSidebarProps> = ({
    ...
    return (
        <div className="hidden pt-6 lg:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-40 xl:px-6 lg:overflow-y-auto lg:bg-white lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col justify-between">
            
            <Image width={300} height={100} src="/images/capture_socialify.png" alt="logo"/>
